    ...
    class Cliente
    {
        ...
        public function __construct()
        {
            if(isset($_POST['tabela'])){
                ...
                if($tableRef == 'formAlterCliente'){ self::alterar();}else
                if($tableRef == 'formClientes'){self::cadastrar();}
                if($tableRef == 'alterExCliente'){self::alterarSituacao($_POST['id']);}
                elseif($_POST['tabela'] == 'excluir'){ self::excluir($_POST['v'], $_POST['assunto']);}
            }
        }
        ...
        public function isImg()
        {
            ...
            if(!empty($_FILES['arquivo']['name'])){
                if(move_uploaded_file($_FILES['arquivo']['tmp_name'], $directory.$new_name)){ return $new_name;}
            }else{
        ...
        public function insertion()
        {
            ...
            $cliente->setEstadoCivil($_POST['estC']);
        ...
        {
            $clientes = new Clientes;
            $clientes->update($this->insertion());
        }

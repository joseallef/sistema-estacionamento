<?php 
    ...
    class Usuario
    {
        ...
        {
            if(empty($_POST['usuario']) || empty($_POST['senha']) || empty($_POST['senha1']) || empty($_POST['senha1'])) {
            ...
            $confirmiNovaSsenha = md5($_POST['senha2']); // Confirm the new password

            if($_POST['password'] == "autenticado")
            {
                if($novaSenha == $confirmiNovaSsenha)
                {

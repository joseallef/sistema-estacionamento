        ...
        <div class="container-fluid con">
            <form action="conteudo-avancado" method="POST" class="form">
                <div class="text text-center m-3 mb-0">
                    <button class="btn btn-dark" name="lembretes">Lembretes</button>
                    <button class="btn btn-dark" name="contro_acesso">Controle de acesso</button>
                    <button class="btn btn-dark" name="historico">Históricos</button>
                </div>
                <?php
                ...
                ?>
                    ...
                    <div class="nome alert alert-dark" role="alert">
                        <input type="text" class="tam text" name="nome" value="" placeholder="Nome...">
                        <button class="btn btn-primary">Pesquisar</button>
                    </div> 
                    <div class="cpf">
                        <input type="text" class="tam cpf" maxlength="14" id="cpf1" name="cpf" placeholder="000.000.000-00"
                        onkeypress="this.value = formatcpf(event)" onpaste="return false;">
                        <button class="btn btn-primary">Pesquisar</button>
                    </div>
                    <div class="Placa">

	...
	?>
			...
			<form action="" method="POST">
				<div class="text text-center bg-dark mt-0 p-3 text-warning">
					...
					<div class="option-pesq bg-dark">
						...
						<input type="text" name="nome" value="" placeholder="Nome ou CPF/CNPJ">
        ...
        <div class="container-field">
            <table class="table table-hover">
				...
				<?php
					if(isset($_POST['todos'])){ $function = $cliente->listarTodos();}elseif(isset($_POST['nome']) && $_POST['nome'] != null){ $function = $cliente->listarCliente($_POST['nome']);}
				...
				<tbody>
					<tr>
						...
						<td><a href="mais-dados-clientes?v=<?php echo $criptor->base64($value['id'], 1); ?>" class="btn btn-primary"><img src="public/img/iconadd.png"></a></td>
					</tr>
				</tbody>
				<?php
					}

    ...
    <div class="text text-center">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">Novo Avulso<br>
                <a href="novo-cliente-avulso" class="btn btn-primary p-2"><i class="fa fa-user-plus"></i></a>                  
            </div>
            <div class="col-md-2 col-sm-6 col-xs-12">Clientes Avulso<br>           
                <a href="clientes-avulso" class="btn btn-primary p-2"><i class="fa fa-users"></i></a>
            </div>
            <div class="col-md-2 div">|</div>
            <div class="col-md-2 col-sm-6 col-xs-12">Novo Mensalista<br>
                <a href="novo-cliente" class="btn btn-primary p-2"><i class="fa fa-user-plus"></i></a>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">Clientes Mensalista<br>            
                <a href="clientes" class="btn btn-primary p-2"><i class="fa fa-users"></i></a>
            </div>
        </div>
    </div>
</section>

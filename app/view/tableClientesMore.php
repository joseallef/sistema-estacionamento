    ...
    ?>
        ...
        <div class="container">
            <table class="table">
                ...
                <tbody>
                    <tr>
                        <td><a href="alterar-cliente?v=<?php echo $criptor->base64($id, 1); ?>" class="btn btn-primary"><i class="fa fa-user-edit"></i></a></td>
                        <td><button data-toggle="modal" class="btn btn-primary" data-target="#excluir-cliente"><img src="public/img/icondelete.png"></button></td>
                        <td><a href="formulario-veiculo?v=<?php echo $criptor->base64($id, 1); ?>" class="btn btn-primary"><img src="public/img/iconadd.png"></a></td>
                        <?php
                            if(!empty($nome)){
                        ?>
                        ...
                        <div class="modal-body">
                            <form action="incluir-alter" method="POST">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-primary" name="v" value="<?php echo $id; ?>"><img src="public/img/icondelete.png" alt="Apagar"></button>
                                </div>
                            </form>
                        </div>
                    </div>

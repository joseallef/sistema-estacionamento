...
class Boleto implements \JsonSerializable
{
     ...
     * @return Pagador
     */
    public function getPagador() : ModelCliente
    {
        return $this->pagador;
    }
     ...
     * @return BancoInter
     */
    public function getController() : GerarBoleto
    {
     ...
     */
    public function setPagador(ModelCliente $modelCliente)
    {
        $this->pagador = $modelCliente;
    }
     ...
     */
    public function setController(GerarBoleto $controller)
    {
